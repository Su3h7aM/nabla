---
title: "TTY Full-Frame Encode Benchmark — Baseline"
tags: [nabla, tty, benchmark, encode]
status: active
created: 2026-08-12
---

# TTY full-frame encode benchmark — baseline

Harness: `tty/bench_tests.odin` (gated behind `-define:BENCH=true`).
...
| Build | `odin run ./tests/tty_tests -collection:nabla=$PWD -define:BENCH=true -o:speed -thread-count:1` |
